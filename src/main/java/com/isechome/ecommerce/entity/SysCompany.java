...
public class SysCompany implements Serializable {
    ...
    private String ecommerce_state;

    public String getEcommerce_state() {
        return ecommerce_state;
    }

    public void setEcommerce_state(String ecommerce_state) {
        this.ecommerce_state = ecommerce_state;
    }
    ...
    public String toString() {
        ...
        sb.append(", sitNo=").append(sitNo);
        sb.append(", comtype=").append(comtype);
        sb.append(", comtype2=").append(comtype2);
        sb.append(", comtype3=").append(comtype3);
        sb.append(", comtranstype=").append(comtranstype);
        sb.append(", tradepasswd=").append(tradepasswd);
        sb.append(", tradepasswdupdate=").append(tradepasswdupdate);
        sb.append(", pysametd=").append(pysametd);
        sb.append(", mobilechecked=").append(mobilechecked);
        sb.append(", linkman=").append(linkman);
        sb.append(", mobilecheckeddate=").append(mobilecheckeddate);
        ...
        sb.append(", isnofinance=").append(isnofinance);
        sb.append(", adminuser1=").append(adminuser1);
        sb.append(", adminuser1date=").append(adminuser1date);
        sb.append(", adminuser2=").append(adminuser2);
        sb.append(", adminuser2date=").append(adminuser2date);
        sb.append(", adminuser3=").append(adminuser3);
        sb.append(", adminuser3date=").append(adminuser3date);
        sb.append(", lastservicedate=").append(lastservicedate);
        sb.append(", lastserviceid=").append(lastserviceid);
        sb.append(", contactfax=").append(contactfax);
        sb.append(", banktype=").append(banktype);
        sb.append(", taxno=").append(taxno);
        sb.append(", regip=").append(regip);
        sb.append(", firstsigndate=").append(firstsigndate);
        ...
        sb.append(", receivesmstype=").append(receivesmstype);
        sb.append(", createdate=").append(createdate);
        sb.append(", createuser=").append(createuser);
        sb.append(", updatedate=").append(updatedate);
        sb.append(", updateuser=").append(updateuser);
        sb.append(", isshowweb=").append(isshowweb);
        sb.append(", startdate=").append(startdate);
        sb.append(", enddate=").append(enddate);
        sb.append(", empowertype=").append(empowertype);
        sb.append(", isshowcj=").append(isshowcj);
        sb.append(", isneedzs=").append(isneedzs);
        sb.append(", bankno=").append(bankno);
        sb.append(", invoicestar=").append(invoicestar);
        sb.append(", invoiceno=").append(invoiceno);
        sb.append(", paypasswd=").append(paypasswd);
        sb.append(", isdowntd=").append(isdowntd);
        sb.append(", gctrybegintime=").append(gctrybegintime);
        sb.append(", gctryendtime=").append(gctryendtime);
        sb.append(", isgctry=").append(isgctry);
        sb.append(", comurl=").append(comurl);
        sb.append(", bankaccount=").append(bankaccount);
        sb.append(", membertypedate=").append(membertypedate);
        sb.append(", istry=").append(istry);
        sb.append(", issteelhq=").append(issteelhq);
        sb.append(", doarea=").append(doarea);
        sb.append(", icnumber=").append(icnumber);
        sb.append(", enterprisecode=").append(enterprisecode);
        sb.append(", variety1=").append(variety1);
        sb.append(", variety2=").append(variety2);
        sb.append(", variety3=").append(variety3);
        sb.append(", variety4=").append(variety4);
        sb.append(", variety5=").append(variety5);
        sb.append(", scSteelcom=").append(scSteelcom);
        sb.append(", dlCom=").append(dlCom);
        sb.append(", rzMarket=").append(rzMarket);
        sb.append(", jyCitys=").append(jyCitys);
        sb.append(", jyVariety=").append(jyVariety);
        sb.append(", zyVariety=").append(zyVariety);
        sb.append(", isdzgys=").append(isdzgys);
        sb.append(", tieluz=").append(tieluz);
        sb.append(", tieluz2=").append(tieluz2);
        sb.append(", tieluz3=").append(tieluz3);
        sb.append(", tieluz4=").append(tieluz4);
        sb.append(", tieluz5=").append(tieluz5);
        sb.append(", matou=").append(matou);
        sb.append(", matou2=").append(matou2);
        sb.append(", matou3=").append(matou3);
        sb.append(", matou4=").append(matou4);
        sb.append(", matou5=").append(matou5);
        sb.append(", istj=").append(istj);
        ...
        sb.append(", gzjadmin1=").append(gzjadmin1);
        sb.append(", gzjadmin2=").append(gzjadmin2);
        sb.append(", kpcom=").append(kpcom);
        sb.append(", kpren=").append(kpren);
        sb.append(", kpaddress=").append(kpaddress);
        sb.append(", kptel=").append(kptel);
        sb.append(", tryOut=").append(tryOut);
        sb.append(", yqCompanyname=").append(yqCompanyname);
        sb.append(", signcompanyname=").append(signcompanyname);
        sb.append(", yqMuban=").append(yqMuban);
        sb.append(", yqLiucheng=").append(yqLiucheng);
        sb.append(", yjSalestype=").append(yjSalestype);
        sb.append(", allowmultifh=").append(allowmultifh);
        sb.append(", jiaogefinishnum=").append(jiaogefinishnum);
        sb.append(", pingjiazongfen1=").append(pingjiazongfen1);
        sb.append(", pingjianum1=").append(pingjianum1);
        sb.append(", pingjiazongfen2=").append(pingjiazongfen2);
        sb.append(", pingjianum2=").append(pingjianum2);
        sb.append(", allowsendjingjiasms=").append(allowsendjingjiasms);
        sb.append(", allowdaizhucemember=").append(allowdaizhucemember);
        sb.append(", mgAtt=").append(mgAtt);
        sb.append(", downprice=").append(downprice);
        sb.append(", mgEndtime=").append(mgEndtime);
        sb.append(", mgStarttime=").append(mgStarttime);
        sb.append(", paytype=").append(paytype);
        sb.append(", cityId=").append(cityId);
        sb.append(", mgUserid=").append(mgUserid);
        sb.append(", mgUsername=").append(mgUsername);
        sb.append(", mgMid=").append(mgMid);
        sb.append(", mgDate=").append(mgDate);
        sb.append(", mgManagedaozhancode=").append(mgManagedaozhancode);
        sb.append(", mgDaozhancode=").append(mgDaozhancode);
        sb.append(", mgDaozhancangku=").append(mgDaozhancangku);
        sb.append(", mgTihuomode=").append(mgTihuomode);
        sb.append(", mgCankaoremarkprice=").append(mgCankaoremarkprice);
        sb.append(", mgCanbuyother=").append(mgCanbuyother);
        sb.append(", mgCanbuymaterialtype=").append(mgCanbuymaterialtype);
        sb.append(", mgMateriallist=").append(mgMateriallist);
        sb.append(", mgIsxieyi=").append(mgIsxieyi);
        sb.append(", mgXieyinum=").append(mgXieyinum);
        sb.append(", mgXieyinum1200=").append(mgXieyinum1200);
        sb.append(", mgIsfengongsi=").append(mgIsfengongsi);
        sb.append(", mgLockprice=").append(mgLockprice);
        sb.append(", mgCanuseshengyukeyres=").append(mgCanuseshengyukeyres);
        sb.append(", mgMonthnum=").append(mgMonthnum);
        sb.append(", mgHetongtotalnum=").append(mgHetongtotalnum);
        sb.append(", mgCapitalpolicy=").append(mgCapitalpolicy);
        sb.append(", mgSubordinatedepartments=").append(mgSubordinatedepartments);
        sb.append(", mgGcdaypricetype=").append(mgGcdaypricetype);
        sb.append(", mgJijiaLuowen=").append(mgJijiaLuowen);
        sb.append(", mgJijiaGaoxian=").append(mgJijiaGaoxian);
        sb.append(", mgJijiaPanluo=").append(mgJijiaPanluo);
